...
var log = console.log; // 1. scroll 이벤트를 감지하는 방법
...
var scrollHandler = function () {
  ...
  var eventType = isFireFox ? "DOMMouseScroll" : "wheel";
  return [eventType, function (e) {
...
(_window = window).addEventListener.apply(_window, _toConsumableArray(scrollHandler));