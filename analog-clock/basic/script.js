...
const renderTime = (() => {
    ...
    return () => {
        ...
        $hourHand.style.setProperty('--deg', currentHours * 30 + currentMinutes * 0.5 + currentSeconds * (0.5 / 60))

        // 분침: 1분은 6deg(360 / 60) = 1초당 0.1deg(6 / 60)
        $minuteHand.style.setProperty('--deg', currentMinutes * 6 + currentSeconds * 0.1);
        
        // 초침: 1초는 초당 6deg(360 / 60)
